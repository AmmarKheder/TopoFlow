#!/bin/bash
#SBATCH --job-name=aq_net2_16x32_optimal
#SBATCH --nodes=100
...
#SBATCH --output=logs/aq_net2_multipoll_from_scratch_%j.out
#SBATCH --error=logs/aq_net2_multipoll_from_scratch_%j.err
...
# Disabling Infiniband to avoid topology errors
...
echo ""
echo "=============================================="
echo "⚙️  NCCL OPTIMIZATIONS ENABLED (FROM SCRATCH)"
echo "=============================================="
...
echo ""
echo "=============================================="
echo "🔥🚀 LAUNCHING FROM SCRATCH TRAINING (16 GPUs) 🚀🔥"
echo "=============================================="
echo "Multi-pollutant training from scratch (6 pollutants: PM2.5, PM10, SO2, NO2, CO, O3)"
echo "Nodes: $SLURM_JOB_NODELIST"
echo "Tasks: $SLURM_NTASKS"
echo "GPUs per node: 8 × 2 NODES = 16 GPUs TOTAL"
echo "=============================================="

# Launch distributed training
srun --ntasks-per-node=1 bash -c "source venv_pytorch_rocm/bin/activate && torchrun --nproc_per_node=8 --nnodes=\$SLURM_JOB_NUM_NODES --node_rank=\$SLURM_NODEID --master_addr=\$MASTER_ADDR --master_port=\$MASTER_PORT main_multipollutants.py --config configs/config_all_pollutants.yaml"
...
echo ""
echo "=============================================="
echo "✅ FROM SCRATCH TRAINING COMPLETED"
echo "=============================================="
